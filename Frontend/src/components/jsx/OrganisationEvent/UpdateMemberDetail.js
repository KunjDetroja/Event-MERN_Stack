...
function UpdateMemberDetail() {
  ...
  const fetchAllMembertypedetails = async () => {
    try {
      ...
      const response = await api.post("/organizationunupdatedmemberdetails",userorindata);
    ...
    //     "/organizationunupdatedmemberdetails",
    //     memberdata
    //   );
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      ...
      if (response.data.success !== false) {
        ...
        navigate("/organizationevents/organizationmemberdetails");
        console.log(response.data);
        setLFormData({
          name: "",
          email: "",
