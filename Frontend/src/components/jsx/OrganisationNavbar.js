...
function OrganisationNavbar() {
  ...
  const isHomeActive = location.pathname === "/organizationevents";
      ...
      <div>
        ...
        >
          <div className="container-fluid" style={{ fontSize: "1.2rem" }}>
            <Link to="/organizationdashboard" className="navbar-brand ms-5">
              EventWiz
            </Link>
            <button
            ...
            >
              ...
              >
                ...
                <li className="nav-item">
                  <NavLink
                    to="/organizationevents/orgevents"
                ...
                <li className="nav-item">
                  <NavLink
                    to="/organizationevents/organizationmemberdetails"
                    className={`nav-link ${isHomeActive ? "" : ""}`}
                  >
                    Member Data
                  </NavLink>
                ...
                <li className="nav-item">
                  <NavLink
                    to="/organizationevents/organizationmemberships"
                    className={`nav-link ${isHomeActive ? "" : ""}`}
                  >
                    Membership
                  </NavLink>
                ...
                <li className="nav-item">
                  <NavLink
                    to="/organizationevents/authorization"
                    className={`nav-link ${isHomeActive ? "" : ""}`}
                  >
                    Authorization
                  </NavLink>
                ...
                <li className="nav-item">
                  <NavLink
                    to="/organizationevents/otherevents"
                    className={`nav-link ${isHomeActive ? "" : ""}`}
                  >
                    Other Events
                  </NavLink>
