...
function UserEvent1() {
  ...
  const fetchAllMemTypedetails = async () => {
    try {
      const response = await api.get("/organisation/allmembershiptype");
      setMemType(response.data.data);
    } catch (error) {
  ...
  const fetchAllClubname = async () => {
    try {
      const response = await api.get("organisation/clubnames/");
  ...
  const fetchAllPostdetails = async () => {
    ...
    try {
      const response = await api.post(
        `/event/postforuser/${userData.username}`
      );
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      const checking = await api.post("/event/postfilter", data);
      if (checking.data.success !== false) {
        setDetails(checking.data.data);
  ...
  const handlesearchSubmit = async (event) => {
    ...
    try {
      const response = await api.post("/event/postsearchbytitle/", data);
      setDetails(response.data.data);
    } catch (error) {
      console.error("Error fetching details:", error);
    }
  ...
  const handlefutureposts = async () => {
    ...
    try {
      const response = await api.post("/event/fetchallfuturepostforuser/", {
        uname: userData.username,
      });
      if (response.data.success != false) {
        setDetails(response.data.data);
                                  ...
                                  <div className="usereventscard_content">
                                    ...
                                    <div className="usereventscard_text">
                                      ...
                                      <p className="cardptag">
                                        ...
                                        <span> TO </span>
                                        <strong> {post.event_end_date.toString().slice(0,10)}</strong>
                                      </p>
